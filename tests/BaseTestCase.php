...
class BaseTestCase extends PHPUnitTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $knownFixtures = [];
        static::$files = static::getFiles(\mb_strtolower($className));
    ...
    public static function getRoot($class)
    {
        if (!static::$exampleRoot) {
            static::$exampleRoot = \dirname(self::TEST_FOLDER) . '/Examples/examples_' . \str_replace('test', '', \mb_strtolower($class)) . '/';
        }
