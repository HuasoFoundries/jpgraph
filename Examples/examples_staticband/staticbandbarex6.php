...
$band[2] = new Plot\PlotBand(
    Graph\Configs::getConfig('HORIZONTAL'),
    Graph\Configs::getConfig('BAND_DIAGCROSS'),
    'min',
    -20,
    'red'
);
...
$band[3] = new Plot\PlotBand(
    Graph\Configs::getConfig('VERTICAL'),
    Graph\Configs::getConfig('BAND_HLINE'),
    0,
    1,
    'darkgray'
);
...
$band[3]->SetOrder(
    Graph\Configs::getConfig('DEPTH_FRONT')
);
$band[4] = new Plot\PlotBand(
    Graph\Configs::getConfig('VERTICAL'),
    Graph\Configs::getConfig('BAND_HVCROSS'),
    5,
    'max',
    'darkgray'
);
...
$graph->AddLine(new Plot\PlotLine(
    Graph\Configs::getConfig('HORIZONTAL'),
    0,
    'black',
    2
