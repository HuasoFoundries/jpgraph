...
$data = [
    ...
    [3, Graph\Configs::getConfig('ACTYPE_NORMAL'), '  Label 4', '2001-11-20', '2001-11-22', ''],
    [4, Graph\Configs::getConfig('ACTYPE_MILESTONE'), '  Phase 1 Done', '2001-11-23', 'M2'], ];

// The constrains between the activities
$constrains = [[1, 2, Graph\Configs::getConfig('CONSTRAIN_ENDEND')],
    [2, 3, Graph\Configs::getConfig('CONSTRAIN_STARTEND')],
    [3, 4, Graph\Configs::getConfig('CONSTRAIN_ENDSTART')],
];
