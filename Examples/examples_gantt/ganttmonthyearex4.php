...
$example_title = 'Adding a spaning title';
...
$graph->ShowHeaders(Graph\Configs::getConfig('GANTT_HMONTH') | Graph\Configs::getConfig('GANTT_HYEAR') | Graph\Configs::getConfig('GANTT_HWEEK'));
...
$graph->scale->tableTitle->SetFont(Graph\Configs::getConfig('FF_ARIAL'), Graph\Configs::getConfig('FS_NORMAL'), 16);
