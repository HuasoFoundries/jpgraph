...
class PiePlot
{
    ...
    {
        if ((0 < $aSize && 0.5 >= $aSize) || (10 < $aSize && 1000 > $aSize)) {
            $this->radius = $aSize;
        } else {
    ...
    public function Stroke($img, $aaoption = 0)
    {
        ...
        if (empty($this->setslicecolors)) {
            ...
            $tt = \array_slice($this->setslicecolors, 0, $n % max(1, $numcolors));
        ...
        for ($i = 0; 0 < $sum && $i < $n; ++$i) {
            ...
            if (0.0001 > $angle2 && 0.0001 < $angle1) {
    ...
    public function StrokeLabel($label, $img, $xc, $yc, $a, $r)
    {
        ...
        if (1.0 > $this->ilabelposadj) {
            ...
            if (1.0 < $this->ilabelposadj && 5.0 > $this->ilabelposadj) {
                $r *= $this->ilabelposadj;
            }
